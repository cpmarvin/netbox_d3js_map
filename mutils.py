...
def get_netbox_connections():
    NB_TOKEN = 'a523246849e32e8cd4ee1c523a6b6c6416900a66'
    NB_URL = 'http://10.99.99.104/'
    ...
    '''
    routers is a list of pynetbox.models.dcim.Devices __repr__ as router name
    useful data is:
    -routers[0].primary_ip4
    -routers[0].site
    -routers[0].device_type
    '''
    for rtr in routers:
        ...
        '''
        interface_connection is a list of pynetbox.models.dcim.InterfaceConnections __repr__ as interface_name
        useful data is:
        -interface_b.name
        -interface_b.device.name
        -interface_a.name
        -interface_a.device.name
        '''
